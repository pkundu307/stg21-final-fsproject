...
const Issue = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        formData.append("phone", issue.phone);
        formData.append("issue", issue.issuedesc);
                    ...
                    >
                        ...
                        <div className="input-box">
                            ...
                            <textarea
                                ...
                                onChange={handleChange}
                                className="text-white mb-4 w-full bg-gray-700 rounded border border-gray-900 focus:border-gray-500 focus:ring-2 focus:ring-gray-900 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"
                                minLength={20}
                                maxLength={100}
                                required
                            />
